...
BEGIN
  ...
  LOOP
    ...
    -- Soma o adicional do gerente quando há autorização registrada
    -- OU quando o desconto aplicado excede o limite básico (fallback para
    -- registros históricos de autorização que possam estar faltando).
    SELECT EXISTS (
