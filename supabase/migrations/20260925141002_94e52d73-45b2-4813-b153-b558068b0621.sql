CREATE SCHEMA IF NOT EXISTS rastreio_private;
REVOKE ALL ON SCHEMA rastreio_private FROM PUBLIC;
...
REVOKE ALL ON FUNCTION rastreio_private.get_rastreio_venda(uuid) FROM PUBLIC;
GRANT USAGE ON SCHEMA rastreio_private TO anon, authenticated;
GRANT EXECUTE ON FUNCTION rastreio_private.get_rastreio_venda(uuid) TO anon, authenticated;
...
SET search_path = public, pg_temp
AS $$
  SELECT rastreio_private.get_rastreio_venda(p_token);
$$;
