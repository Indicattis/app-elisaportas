      ...
      <CardContent className="space-y-4 pb-4">
        ...
        {onVendaPresencialChange && (
          <div className="space-y-2">
            ...
            <RadioGroup
              value={vendaPresencial === null || vendaPresencial === undefined ? '' : vendaPresencial ? 'frio' : 'quente'}
              onValueChange={(v) => onVendaPresencialChange(v === 'frio')}
            ...
            >
              ...
              >
                ...
                <span className={cn(
                  "text-sm font-medium",
                  vendaPresencial === true ? "text-cyan-100" : "text-cyan-200/70"
                )}>Frio</span>
              </label>
              <label
                htmlFor="temp-quente"
              ...
              >
                ...
                <span className={cn(
                  "text-sm font-medium",
                  vendaPresencial === false ? "text-orange-100" : "text-orange-200/70"
                )}>Quente</span>
              </label>
            </RadioGroup>
          </div>
