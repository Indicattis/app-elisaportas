...
import HistoricoContratos from "./pages/vendas/HistoricoContratos";
      ...
      <TooltipProvider delayDuration={200}>
        <AuthProvider>
          <ErrorBoundary>
            ...
            <Route path="/financeiro/balanco-descontos" element={<ProtectedRoute routeKey="financeiro_hub" alternativeRouteKeys={["admin_financeiro"]}><BalancoDescontos /></ProtectedRoute>} />
            <Route path="/marketing/balanco-descontos" element={<Navigate to="/financeiro/balanco-descontos" replace />} />
                ...
                <Route path="/vendas/minhas-vendas/rascunho/:id" element={<ProtectedRoute routeKey="vendas_hub"><RascunhoView /></ProtectedRoute>} />
                <Route path="/vendas/minhas-vendas/:id" element={<ProtectedRoute routeKey="vendas_hub"><VendaDetalhesMinimalista /></ProtectedRoute>} />
                ...
                <Route path="/direcao/vendas/contratos/historico" element={<ProtectedRoute routeKey="direcao_vendas"><HistoricoContratos /></ProtectedRoute>} />
                ...
                <Route path="/direcao/vendas/regras" element={<ProtectedRoute routeKey="direcao_vendas"><RegrasVendasView /></ProtectedRoute>} />
...
{/* Hub de Estoque da Direção */}
                ...
                <Route path="/financeiro/custo-folha" element={<ProtectedRoute routeKey="financeiro_hub" alternativeRouteKeys={["admin_financeiro"]}><CustoFolhaMensal /></ProtectedRoute>} />
                ...
                <Route path="/administrativo/financeiro/*" element={<RedirectFinanceiroLegacy />} />
