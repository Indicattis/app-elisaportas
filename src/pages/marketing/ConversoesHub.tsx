...
export default function ConversoesHub() {
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full h-12 rounded-lg active:scale-[0.98] flex items-center gap-4 px-5 text-white font-medium bg-gradient-to-r from-blue-500 to-blue-700 shadow-lg shadow-blue-500/20 border border-blue-400/30 hover:from-blue-400 hover:to-blue-600 transition-all duration-300"
                >
