    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div className={`${cardClass} border-l-4 ${venda.temperatura === true ? 'border-l-blue-500' : venda.temperatura === false ? 'border-l-orange-500' : 'border-l-white/30'}`}>
            <div className="flex items-center gap-2 text-white/60 text-sm mb-1">
              <Thermometer className="w-4 h-4" />
              Temperatura
            </div>
            <p className={`text-xl font-bold ${venda.temperatura === true ? 'text-blue-400' : venda.temperatura === false ? 'text-orange-400' : 'text-white/30'}`}>
              {venda.temperatura === true ? 'Fria' : venda.temperatura === false ? 'Quente' : 'Não informado'}
            </p>
          </div>
        </div>
