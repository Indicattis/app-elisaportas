...
import { ArrowLeft, DollarSign, Target, Wallet } from 'lucide-react';
...
export default function DirecaoFinanceiroHub() {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-10 w-full max-w-md">
        ...
        >
          ...
          <p className="text-sm text-white/50 mt-1">Faturamento e metas</p>
        </div>
