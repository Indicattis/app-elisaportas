...
const menuItems = [
  { label: 'Instalação Autorizados', icon: Wrench, path: '/autorizados/instalacao' },
  { label: 'Gestão Autorizados', icon: Building2, path: '/autorizados/gestao' },
];

export default function AutorizadosHome() {
